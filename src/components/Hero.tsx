        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center h-full">
          <div className="text-center lg:text-left">
            ...
            animationDelay: '0.2s'
              ...
              <div className="text-left">
                <h1 className="text-3xl md:text-4xl text-white leading-tight font-bold xl:text-5xl">
                  Gestão e Assessoria
                  <span className="block text-accent-warm"> para a Área da Saúde</span>
                </h1>
              </div>
            </div>
            ...
            animationDelay: '1.1s'
              ...
              <Button size="lg" className="bg-accent-teal hover:bg-accent-teal/90 text-white shadow-glow" onClick={() => window.open('https://wa.me/5555991295341?text=Olá! Gostaria de saber mais sobre os serviços da Onestà Contabilidade.', '_blank')}>
                Fale Conosco
