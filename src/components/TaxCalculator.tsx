              ...
              <Card className="shadow-lg border border-primary/20 card-hover-lift">
                <CardContent className="p-8">
                  <div className="text-center mb-6">
                    <h3 className="text-xl font-bold text-primary mb-2">Calcule Sua Economia</h3>
                    <p className="text-sm text-muted-foreground">Informe apenas seu faturamento mensal</p>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    {isCalculating && (
                      <div className="text-center py-8">
                        <div className="inline-flex items-center px-4 py-2 bg-accent-teal/10 rounded-full">
                          ...
                          <span className="text-sm text-accent-teal font-medium">Calculando sua economia...</span>
                        </div>
                      </div>
                    )}
                    ...
                    {!results && !isCalculating && (
                      <div className="text-center py-4">
                        ...
                        <p className="text-sm text-muted-foreground">Informe seu faturamento e clique em "Calcular"</p>
                      </div>
                    )}
                      ...
                      <div className="space-y-4 lg:hidden">
                        <div className="text-center pt-4">
                          <Button
                            ...
                            onClick={() =>
                              window.open(
                                "https://wa.me/5555991295341?text=Olá! Vi a calculadora no site e gostaria de saber mais sobre como economizar nos impostos.",
                                "_blank",
                              )
                            }
                          >
                          ...
                          <p className="text-xs text-muted-foreground mt-2">Consulta gratuita • Resposta imediata</p>
                        </div>
                      </div>
                    )}
                  </div>
                ...
                <div className="bg-gradient-to-br from-primary/5 to-accent-teal/5 rounded-2xl p-6 border border-primary/20">
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-6">
                    <div className="bg-white border-2 border-muted rounded-xl p-4 relative">
                      <div className="text-center">
                        ...
                        <div className="text-xs text-muted-foreground bg-muted px-2 py-1 rounded-full">27% do faturamento</div>
                      </div>
                    ...
                    <div className="bg-white border-2 border-primary/30 rounded-xl p-4 relative">
                      <div className="text-center">
                        ...
                        <div className="text-xs text-primary bg-primary/10 px-2 py-1 rounded-full">11,4% do faturamento</div>
                      </div>
                      <div className="absolute -top-2 -right-2 bg-primary text-white text-xs px-2 py-1 rounded-full">OTIMIZADO</div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-primary rounded-xl p-6 text-white text-center mb-6">
                    ...
                    <div className="flex items-center justify-center gap-2 mb-2">
                      <div className="text-lg font-medium bg-white/20 rounded-full px-4 py-1">{results.percentage}% de economia</div>
                    </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
                    <div className="bg-white border border-muted rounded-lg p-4 text-center">
                      ...
                      <div className="text-xl font-bold text-foreground">R$ {(results.savings * 12).toLocaleString("pt-BR")}</div>
                      <div className="text-xs text-muted-foreground mt-1">Em 12 meses</div>
                    </div>
                    <div className="bg-white border border-muted rounded-lg p-4 text-center">
                      <div className="text-xs text-muted-foreground mb-1 font-medium">ECONOMIA EM 5 ANOS</div>
                      <div className="text-xl font-bold text-foreground">R$ {(results.savings * 60).toLocaleString("pt-BR")}</div>
                      <div className="text-xs text-muted-foreground mt-1">Potencial de investimento</div>
                    </div>
                  </div>
                  ...
                  <div className="hidden lg:block">
                    ...
                    <p className="text-xs text-muted-foreground mt-2 text-center">Consulta gratuita • Resposta imediata</p>
                  </div>
                </div>
              )}
            </div>
